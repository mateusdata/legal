...
const App = () => {
  return (
    <div className="p-10 font-sans leading-relaxed">
      ...
      <p className="mb-4">
        As informações coletadas podem ser utilizadas para permitir funcionalidades do aplicativo, gerenciamento de contas de usuários, envio de alertas e notificações sobre o nível do rio e condições climáticas, comunicação com os usuários quando necessário e melhoria geral da experiência do serviço.
      </p>
      ...
      <p className="mb-4">
        O aplicativo pode enviar notificações de alerta relacionadas a situações de risco, como elevação do nível do rio ou previsão de chuvas intensas. O usuário pode gerenciar as preferências de notificação diretamente nas configurações do aplicativo ou do dispositivo.
      </p>
      ...
      <p>
        Se você tiver dúvidas sobre esta Política de Privacidade ou sobre o funcionamento do aplicativo, entre em contato conosco pelo e-mail:{" "}
        <a href="mailto:mateuspele2015@gmail.com">mateuspele2015@gmail.com</a>.
      </p>
    </div>
  );
};
