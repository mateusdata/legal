  ...
  return (
    <div className="p-10 font-sans leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">
        Exclusão de Conta - memory-flip
      </h1>

      <p className="mb-4">
        Esta página explica como você pode excluir sua conta no aplicativo <strong>memory-flip</strong>.
        O <strong>memory-flip</strong> permite que os usuários excluam suas contas diretamente pelo aplicativo.
      </p>
      ...
      <p className="mb-4">
        Para excluir sua conta do <strong>memory-flip</strong>, siga os passos abaixo:
      </p>

      <ol className="list-decimal ml-6 mb-4">
        <li>Abra o aplicativo memory-flip.</li>
