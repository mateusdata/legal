  ...
  return (
    <div className="p-10 font-sans leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">
        Exclusão de Conta - bubblepop
      </h1>

      <p className="mb-4">
        Esta página explica como você pode excluir sua conta no aplicativo <strong>bubblepop</strong>.
        O <strong>bubblepop</strong> permite que os usuários excluam suas contas diretamente pelo aplicativo.
      </p>
      ...
      <p className="mb-4">
        Para excluir sua conta do <strong>bubblepop</strong>, siga os passos abaixo:
      </p>

      <ol className="list-decimal ml-6 mb-4">
        <li>Abra o aplicativo bubblepop.</li>
